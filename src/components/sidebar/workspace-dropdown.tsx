...
const WorkspaceDropdown: React.FC<WorkspaceDropdownProps> = ({privateWorkspaces, collaboratingWorkspaces, sharedWorkspaces, defaultValue,}) => {
    ...
    return (
        <div className={'relative inline-block text-left'}>
            ...
            {isOpen && (
                <div className={'origin-top-right absolute min-w-[250px] w-full rounded-md shadow-md z-50 h-[190px] bg-black/10 backdrop-blur-lg group overflow-scroll border-[1px] border-muted'}>
